...
if ( ! empty( $search_s['enabled'] ) ) :
	...
	$quick_tags_raw  = $search_s['quick_tags'] ?? 'Action, Sci-Fi, Avengers, Avatar, Anime, Horror, Christopher Nolan, 4K';
			...
			<div class="doodh-spotlight-inner">
				<div class="doodh-spotlight-header">
					<div class="doodh-spotlight-badge">
						...
						<i class="fas fa-bolt"></i> <?php esc_html_e( 'Ultra-Fast Instant Search', 'vmtheme' ); ?>
					</div>
					...
					<div class="doodh-hero-content">
						...
						<div class="doodh-hero-btns">
							<a href="<?php the_permalink(); ?>" class="doodh-btn-primary">
								<i class="fas fa-play"></i> <?php esc_html_e( 'Watch Now', 'vmtheme' ); ?>
							</a>
