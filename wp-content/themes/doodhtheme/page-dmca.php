	...
	<article class="doodh-legal-box">
		<header style="border-bottom:1px solid var(--dt-border); padding-bottom:20px; margin-bottom:25px;">
			<h1 style="font-size:32px; font-weight:800; color:#fff; display:flex; align-items:center; gap:10px;">
				<i class="fas fa-shield-alt" style="color:var(--dt-primary);"></i> <?php esc_html_e( 'DMCA & Copyright Notice', 'doodhtheme' ); ?>
			</h1>
			<p style="color:var(--dt-text-muted); font-size:14px; margin-top:5px;"><?php esc_html_e( 'Digital Millennium Copyright Act Compliance Policy', 'doodhtheme' ); ?></p>
		</header>

		<div class="doodh-legal-content" style="color:#cbd5e1; line-height:1.8; font-size:15px;">
			<h3 style="color:#fff; margin-top:20px;"><?php esc_html_e( '1. Non-Hosting & Third-Party Content Disclaimer', 'doodhtheme' ); ?></h3>
			<p>
			...
			<h3 style="color:#fff; margin-top:25px;"><?php esc_html_e( '2. Notice and Takedown Procedure', 'doodhtheme' ); ?></h3>
			<p>
			...
			<div style="background:var(--dt-bg-surface); border:1px solid var(--dt-border); padding:20px; border-radius:var(--dt-radius); margin-top:30px;">
				<h4 style="color:#fff; margin-bottom:8px;"><i class="fas fa-envelope" style="color:var(--dt-primary);"></i> <?php esc_html_e( 'Designated Copyright Contact Agent', 'doodhtheme' ); ?></h4>
