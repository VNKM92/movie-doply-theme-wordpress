...
while ( have_posts() ) :
	...
	<main class="container vmtheme-blog-single-container" style="padding-top: 35px; padding-bottom: 60px;">
		...
		<div class="vmtheme-article-layout">
			...
			<!-- Video Streaming Player (if enabled for standard posts) -->
			<?php if ( doodhtheme_is_player_enabled( $post_id ) ) : ?>
				<div style="margin: 25px 0;">
					<?php doodhtheme_render_player( $post_id ); ?>
				</div>
			<?php endif; ?>

			<!-- Download Links Box (if enabled for standard posts) -->
			<?php doodhtheme_render_downloads( $post_id ); ?>
